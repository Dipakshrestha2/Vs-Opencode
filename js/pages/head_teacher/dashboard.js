...
function renderHeadTeacherDashboard(container) {
  ...
  container.innerHTML = `
    ...
    <div class="grid-2">
      ...
      <div class="card">
        <div class="card-header"><h3>Recent Submissions</h3><a href="#/head_teacher/submissions" class="btn btn-sm btn-secondary">View All</a></div>
        <div class="card-body">
          <div class="recent-list">
...
function renderTeachers(container) {
  ...
  import('../../components/table.js').then(({ renderTable }) => {
    renderTable({
      ...
      data: teachers,
      actions: [{ id: 'monitor', label: 'Monitor', type: 'primary', onClick: (id) => { window.location.hash = '#/head_teacher/monitor'; } }]
    });
  });
}
